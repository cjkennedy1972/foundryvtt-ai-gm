...
class EventStore:
    ...
    async def get_events(
        ...
        return await self.db.get_events_full(campaign, session_id=session_id, limit=limit)
    ...
    async def replay(self, campaign: str) -> Dict[str, Any]:
        """Rebuild campaign-lifetime game state from the full event log,
        oldest first, across every session in the campaign."""
        state: Dict[str, Any] = {}
